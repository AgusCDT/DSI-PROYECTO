...
namespace Meditics
{
    public sealed partial class Tutorial : Page
    {
        public Tutorial()
        {
            ...
            items.Add(new FlipViewItem
            {
                ImagePath = "Assets/playersCap.png",
            ...
            items.Add(new FlipViewItem
            {
                ImagePath = "Assets/terrenoCap.png",
            ...
            items.Add(new FlipViewItem
            {
                ImagePath = "Assets/tiendaCap.png",
